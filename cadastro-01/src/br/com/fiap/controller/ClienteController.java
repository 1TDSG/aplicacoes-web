 ...
 */
@WebServlet(description = "Controladora de acesso e requisições.", urlPatterns = { "/clientes", "/listar", "/update" })
public class ClienteController extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Request realizado para a atualização dos dados na lista.
			...
			//Recuperar um cliente da lista através de um ID que vem no parâmetro do request.
